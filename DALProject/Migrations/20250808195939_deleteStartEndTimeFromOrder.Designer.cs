...
namespace DALProject.Migrations
{
    ...
    [Migration("20250808195939_deleteStartEndTimeFromOrder")]
    partial class deleteStartEndTimeFromOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DALProject.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2025, 8, 8, 22, 59, 37, 331, DateTimeKind.Local).AddTicks(9397),
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2025, 8, 8, 22, 59, 37, 331, DateTimeKind.Local).AddTicks(9404),
            ...
            modelBuilder.Entity("DALProject.Models.OrderHeader", b =>
                {
                    ...
                    b.HasOne("DALProject.Models.Technician", null)
                        .WithMany("OrderHeaders")
                        .HasForeignKey("TechnicianId");
